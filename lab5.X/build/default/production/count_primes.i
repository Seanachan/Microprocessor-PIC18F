...
_count_primes:
 ...
 MOVFF 0x20, 0x22
    big_loop:
 MOVLW 0x22
 CPFSLT 0x21 ;if idx<_end
 GOTO finish ;idx >= _end

 MOVFF LATD ;original value

 MOVLW 0x02
 MOVWF LATC ;INCREASING INDEX
 ...
 loop:
     ...
     CPFSLT LATC ;if 0x01 < 0x02
     GOTO prime; >=

     MOVLW 0x0A
     MOVWF 0x20 ;remainder
     ;rem: 0x03
  ...
  BTFSC STATUS, 0 ;if borrow(C=0), rem<0x02
  GOTO done
